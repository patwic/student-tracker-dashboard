angular.module('app').directive('cohortLineChart', function() {
  return {
    restrict: 'AE',
    ...
    controller: function($scope, $window) {
      ...
      const data = makeDataObject($scope.cohortTimeData);
      ...
      const width = document.getElementById('cohortLineChartDiv').offsetWidth - margin.right - margin.left;
      const height = document.getElementById('cohortLineChartDiv').offsetHeight - margin.top - margin.bottom - 80;
      ...
      const overlayWidth = width * (($scope.cohortTimeData.length - 1) / 100) - 1;
      ...
      const updateCohortLineChart = someData => {
        ...
        const newWidth = document.getElementById('cohortLineChartDiv').offsetWidth - margin.right - margin.left;
        const newHeight = document.getElementById('cohortLineChartDiv').offsetHeight - margin.top - margin.bottom - 80;
        ...
        const ya = d3.select('#cohortLineChart').selectAll('.y.axis');
        ...
        const gradient = d3.select('#cohortLineChart').selectAll('.area');

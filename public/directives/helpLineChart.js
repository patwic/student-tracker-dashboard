angular.module('app')
  .directive('helpLineChart', function () {
    return {
      restrict: 'AE',
      ...
      controller: function ($scope) {
        ...
        var data = makeDataObject($scope.helpTimeData);
        ...
        var svg = d3.select("#helpLineChart").append("svg")
        ...
        let overlayWidth = (width * (($scope.helpTimeData.length - 1) / 100)) - 1
        ...
        let updateCohortLineChart = (someData) => {
          ...
          var ya = d3.select('#helpLineChart')
            .selectAll('.y.axis')

          var lines = d3.select('#helpLineChart')
            .selectAll('.line')
            .datum(newData)
          ...
          var gradient = d3.select('#helpLineChart').selectAll(".area")

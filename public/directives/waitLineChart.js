angular.module('app')
  .directive('waitLineChart', function () {
    return {
      restrict: 'AE',
      ...
      controller: function ($scope) {
        ...
        var data = makeDataObject($scope.waitTimeData);
        ...
        var width = document.getElementById('waitQDiv').offsetWidth - margin.right - margin.left;
        var height = document.getElementById('waitQDiv').offsetHeight - margin.top - margin.bottom - 50;
        ...
        var svg = d3.select("#waitLineChart").append("svg")
        ...
        let overlayWidth = (width * (($scope.waitTimeData.length - 1) / 100)) - 1
        ...
        let updateCohortLineChart = (someData) => {
          ...
          var ya = d3.select('#waitLineChart')
            .selectAll('.y.axis')

          var lines = d3.select('#waitLineChart')
            .selectAll('.line')
            .datum(newData)
          ...
          var gradient = d3.select('#waitLineChart').selectAll(".area")

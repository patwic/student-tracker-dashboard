angular.module('app').directive('surveyScatter', function() {
  return {
    ...
    controller: function($scope) {
      ...
      const filteredData = $scope.sd; // All data;
      ...
      const data = averages(filteredData);
      const margin = {
        top: 40,
        right: 40,
        bottom: 30,
      ...
      const width = document.getElementById('graphBoxDiv').offsetWidth - margin.right - margin.left;
      const height = document.getElementById('graphBoxDiv').offsetHeight - margin.top - margin.bottom - 80;
      ...
      const tip = d3
        ...
        .html(function(d) {
          ...
          return `Average Rating: <span style='color:#21AAE1; line-height: 1.5;'> ${
            d[survey]
          }</span><br>Responded: <span style='color:#21AAE1; line-height: 1.5;'> ${d[count]}</span></span><br>Program: <span style='color:#21AAE1; line-height: 1.5;'> ${d.program.toUpperCase()}</span>`;
        });
